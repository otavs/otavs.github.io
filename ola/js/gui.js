...
function populateGUI() {
	...
	gui.spawnRangeMinX = spawnFolder.add(window, 'spawnRangeMinX', 0, windowWidth).listen().name('Min x')
	gui.spawnRangeMaxX = spawnFolder.add(window, 'spawnRangeMaxX', 0, windowWidth).listen().name('Max x')
	gui.spawnRangeMinY = spawnFolder.add(window, 'spawnRangeMinY', 0, windowHeight).listen().name('Min y')
	gui.spawnRangeMaxY = spawnFolder.add(window, 'spawnRangeMaxY', 0, windowHeight).listen().name('Max y')
